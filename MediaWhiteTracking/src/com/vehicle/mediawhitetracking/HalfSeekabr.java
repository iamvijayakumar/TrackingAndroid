...
public class HalfSeekabr extends View {
	...
	// Default values
	private static final float DEFAULT_CIRCLE_X_RADIUS = 60f;
	private static final float DEFAULT_CIRCLE_Y_RADIUS = 60f;
	private static final float DEFAULT_POINTER_RADIUS = 0f;
	private static final float DEFAULT_POINTER_HALO_WIDTH = 0f;
	private static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 0f;
	private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 10f;
	...
	static int DEFAULT_MAX = 100;
	private static final int DEFAULT_PROGRESS = 0;
	private static final int DEFAULT_CIRCLE_COLOR = Color.DKGRAY;
	private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.parseColor("#55c064");
	private static final int DEFAULT_POINTER_COLOR = Color.TRANSPARENT;
	private static final int DEFAULT_POINTER_HALO_COLOR =  Color.TRANSPARENT;
	private static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH =  Color.TRANSPARENT;
	private static final int DEFAULT_CIRCLE_FILL_COLOR = Color.TRANSPARENT;
	private static final int DEFAULT_POINTER_ALPHA = 0;
	private static final int DEFAULT_POINTER_ALPHA_ONTOUCH = 0;
	private static final boolean DEFAULT_USE_CUSTOM_RADII = false;
	private static final boolean DEFAULT_MAINTAIN_EQUAL_CIRCLE = false;
	...
	public HalfSeekabr(Context context) {
		super(context);
		init(null, 0);
	}

	public HalfSeekabr(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public HalfSeekabr(Context context, AttributeSet attrs, int defStyle) {
	...
	*/
	public interface OnCircularSeekBarChangeListener {
		...
		public abstract void onProgressChanged(HalfSeekabr circularSeekBar, int progress, boolean fromUser);

		public abstract void onStopTrackingTouch(HalfSeekabr seekBar);

		public abstract void onStartTrackingTouch(HalfSeekabr seekBar);
	}
